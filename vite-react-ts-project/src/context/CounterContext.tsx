import { createContext, useCallback, useContext, useReducer, type ChangeEvent, type ReactElement } from "react"
...
export const CounterProvider = ({children, ...initState}: ChilrenType & StateType): ReactElement => {
    return (
